...
import '../../protobuf/struct.pbenum.dart' as $5;
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Value', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4.LatLng>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'geoPointValue', subBuilder: $4.LatLng.create)
    ..aOM<ArrayValue>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arrayValue', subBuilder: ArrayValue.create)
    ..aOM<$3.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestampValue', subBuilder: $3.Timestamp.create)
    ..e<$5.NullValue>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nullValue', $pb.PbFieldType.OE, defaultOrMaker: $5.NullValue.NULL_VALUE, valueOf: $5.NullValue.valueOf, enumValues: $5.NullValue.values)
  ...
  @$pb.TagNumber(8)
  $4.LatLng get geoPointValue => $_getN(5);
  @$pb.TagNumber(8)
  set geoPointValue($4.LatLng v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasGeoPointValue() => $_has(5);
  @$pb.TagNumber(8)
  void clearGeoPointValue() => clearField(8);
  @$pb.TagNumber(8)
  $4.LatLng ensureGeoPointValue() => $_ensure(5);
  ...
  @$pb.TagNumber(10)
  $3.Timestamp get timestampValue => $_getN(7);
  @$pb.TagNumber(10)
  set timestampValue($3.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasTimestampValue() => $_has(7);
  @$pb.TagNumber(10)
  void clearTimestampValue() => clearField(10);
  @$pb.TagNumber(10)
  $3.Timestamp ensureTimestampValue() => $_ensure(7);

  @$pb.TagNumber(11)
  $5.NullValue get nullValue => $_getN(8);
  @$pb.TagNumber(11)
  set nullValue($5.NullValue v) { setField(11, v); }
  @$pb.TagNumber(11)
